...
Fit.model.ESM = function(Model, N, N.0, N.1, n.days, n.beeps, 
...
# Simulate Data 
data = Sim.Data.ESM(Model,N,N.0, N.1, 
n.days, n.beeps, isX.center, Ylag.center, isW.center, 
...
if (Opt.Method == 1){
if (is.rho.zero==TRUE){
fit = try(summary(lme(Y ~ X ,random = ~1 | subjno, data=data[[r]],
control=lmeControl(opt='optim'),method='ML',correlation = corAR1())),silent = TRUE)
}
if (is.rho.zero==FALSE){
fit = try(summary(lme(Y ~ X ,random = ~1 | subjno, data=data,
